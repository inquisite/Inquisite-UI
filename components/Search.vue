                                ...
                                <div v-bind:class="'card searchBlock ' + [exportRecords.indexOf(v.__id) >= 0 ? 'export-card' : '']">
                                    <div class="search-result-block">
                                        <div class="row">
                                            ...
                                            <div v-if="results[i]['type'] != 'Person'" class="col-2 text-right search-result-text">
                                                ...
                                                <button v-if="v.__repo_id != activeRepoID && results[i]['type'] != 'Data'" class="btn btn-secondary" v-on:click="setActiveRepo(v.__repo_id)"><small>Load Repo</small></button>
